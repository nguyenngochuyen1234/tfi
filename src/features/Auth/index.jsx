    ...
    return (
        <div className="auth-body">
            <div className="form-container">
                {
                    authRoute === 'login' && <div style={{ minWidth: "400px", display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
                ...
                {
                    authRoute === 'register' && <div style={{ minWidth: "400px" }}>
